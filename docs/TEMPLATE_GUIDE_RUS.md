...
2. **Поля**
   ...
   - Verbose signal logs vkluchayutsya v Settings -> Diagnostics kogda nuzhno posmotret' heartbeat.
...
## 7. Sequence Lock (���������������� MQTT-����)

**����:** ����� ��������� �������� ���������� MQTT-��������� plate/1 � plate/6. ������ ������ ������ �� � ���������� �������; ������ ������������������ �������� ������ ���� � success.mp3, ����� ������ ��� ������� ���������� ��������, �������� ������� ���� � ail.mp3.

1. **�������� ����������**
   - Device ID: sequence_gate`r
   - Template: Sequence Lock`r
2. **����**
   - ��� 1: 	opic = plate/1, payload = touch, payload_required = true`r
   - ��� 2: 	opic = plate/2, payload = touch, payload_required = true`r
   - ����������� �� ���� 6 �� ������ ��������.
   - ��� ������� �������� ���������: hint_topic = hints/led, hint_payload = 1, hint_audio_track = /sdcard/audio/hint1.mp3, ����� ������ ����� ������ ���������� ���.
3. **��������� ��������**
   - 	imeout_ms = 8000 � ���� ��������� ��� �� �������� � ������� 8 ������, �������� ������������.
   - 
eset_on_error = true � ����� ������ ���� ��������� ���������� ������������������ � ���� 1.
4. **��������**
...
5. **��������**
   - unlock_sequence: ��� 1 � MQTT 
elay/cmd � open; ��� 2 � ������������� /sdcard/audio/unlocked.mp3.
   - 
eset_sequence: ��� 1 � MQTT 
elay/cmd � lock; ��� 2 � set_flag sequence_ready=true.
6. **��������**
   - ��������� 	ouch ��������������� �� plate/1�plate/6: � ���� �������� ������ [Sequence] step_ok �, ���������� success-��������.
   - ��������� ��������� �� � ��� �������: ��� ������� event=fail, ���������� fail-��������, ��������� ������� ����� �������� � ���� 1.
